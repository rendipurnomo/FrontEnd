...
import UsExpress from '../../asset/images/logo-american-express.svg'
import Fedex from '../../asset/images/logo-fedex.svg'
import Dhl from '../../asset/images/logo-dhl.svg'
import MidTrans from '../../asset/images/logo-midtrans.png'
import Bitcoin from '../../asset/images/logo-bitcoin.svg'
import MasterCard from '../../asset/images/logo-mastercard.svg'
              ...
              <form action="success.html">
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    disabled
                    className="bg-blue-600 text-white hover:bg-blue-800 hover:text-white focus:outline-none w-full py-3 rounded-full text-lg focus:text-black transition-all duration-200 px-6"
                  >
                    Checkout Now
                  </button>
                </div>
