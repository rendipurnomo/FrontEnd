    ...
    <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      <div className="mb-12 md:mb-0">
        <div className="flex justify-center mb-6">
          <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(1).jpg" alt="gambar"className="rounded-full shadow-lg w-32" />
        </div>
      ...
      <div className="mb-12 md:mb-0">
        <div className="flex justify-center mb-6">
          <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(2).jpg" alt="pictur" className="rounded-full shadow-lg w-32" />
        </div>
      ...
      <div className="mb-0">
        <div className="flex justify-center mb-6">
          <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg" alt='pictur' className="rounded-full shadow-lg w-32" />
        </div>
