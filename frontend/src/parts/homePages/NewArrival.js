        ...
        <div className="flex -mx-4 flex-row relative">
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./images/newArrival-jacket.jpg"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
            <h5 className="text-lg font-semibold mt-4">Jacket</h5>
            <span className="">IDR 189.300</span>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./images/newArrival-tshirt.jpg"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
            <h5 className="text-lg font-semibold mt-4">T-shirt</h5>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./images/newArrival-pant.jpg"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
            <h5 className="text-lg font-semibold mt-4">Jeans</h5>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./images/newArrival-shoes.jpg"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
            <h5 className="text-lg font-semibold mt-4">Shoes</h5>
